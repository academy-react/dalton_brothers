...
const CourseIntroduction = () => {
  return (
    <div>
        ...
        {/* //////// main title /////// */}
        <h4 className=" w-full h-[50px] text-center text-2xl my-5 font-bold">
          {" "}
          معرفی دوره{" "}
        </h4>
        <div className=" px-[40px] py-[10px] ">
        <h5 className=" text-xl text-right font-bold"> پیش گفتار  </h5>
        <p className="text-lg text-right my-[10px] text-gray-800"> بیت تورنت به شکل مهیبی در بین کاربران محبوب شد و پیش‌بینی می‌شود بیش از ربع میلیارد کاربر در سراسر جهان از آن استفاده می‌کنند. سال گذشته تام یورک از گروه موسیقی رادیوهد، آلبوم جدیدش را به صوت اختصاصی روی بیت تورنت منتشر کرد.
