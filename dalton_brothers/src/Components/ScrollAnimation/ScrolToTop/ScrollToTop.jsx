...
const ScrollToTop = () => {
  ...
  return (
    <div>
      <div className='bg-gray-300  xl:h-20 md:h-20 h-16 fixed bottom-16 2xl:right-20 xl:right-16 md:right-9 right-2 xl:w-20 md:w-20 w-16 xl:z-10 rounded-full overflow-hidden opacity-50'>
