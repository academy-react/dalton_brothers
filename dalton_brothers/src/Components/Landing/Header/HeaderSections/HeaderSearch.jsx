...
const HeaderSearch = () => {
  return (
    <label
      htmlFor="searchInput"
      className="lg:w-[50vw] lg:mt-[150px] relative flex flex-row flex-nowrap h-[65px] w-[70vw] mx-auto mt-[100px] border-2 rounded-full py-1 justify-start items-center px-5 gap-3"
    >
