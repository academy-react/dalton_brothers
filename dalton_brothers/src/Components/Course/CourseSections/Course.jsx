    ...
    <div className="w-[350px] h-96 border  rounded-lg flex flex-col">
      ...
      <div className="w-full h-1/2  rounded-t-lg flex justify-center flex-row-reverse">
        ...
        <div className="w-1/3 flex flex-col  ">
          <div className="w-full h-1/3 flex justify-start pl-[20px] items-center">
      ...
      <div className=" w-full h-[170px]  flex flex-col gap-[10px] rounded-b-lg mt-7 ">
        <span className="flex flex-row-reverse p-3 pb-1 text-xl font-sha">
          {courseName}
        </span>
        <span className="flex flex-row-reverse pr-3 text-neutral-600 text-sm font-sha">
          {courseMaster}
        </span>
        <span className="flex flex-row-reverse pr-3 text-neutral-400 text-xs font-sha">
        ...
        <div className="w-full h-1/2  rounded-b-lg flex justify-center flex-row-reverse ">
          <div className="w-1/2  flex justify-center items-center flex-row-reverse text-sm text-[#d2a142] font-est">
            {price} : قیمت
          </div>
          <div className="w-1/2  bg-[#d2a142] text-slate-100 rounded-tr-2xl rounded-bl-lg flex justify-center items-center font-est">
            اطلاعات بیشتر
          </div>
        </div>
