  ...
  return (
    <div className=' w-full h-full flex flex-col pt-7 px-2 font-irSans'>
      <div className=' w-full h-[100px] flex justify-evenly items-center flex-row-reverse xl:text-xl text-lg whitespace-nowrap'>
        <div className='w-[130px] h-[50px] text-center text-gray-600'> تصویر </div>
        <div className='w-[130px] h-[50px] text-center text-gray-600'> نام دوره </div>
        ...
        <div className='w-[130px] h-[50px] text-center text-gray-600 '> تاریخ شروع </div>
