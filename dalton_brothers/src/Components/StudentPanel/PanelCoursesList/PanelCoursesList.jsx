...
const PanelCoursesList = () => {
  return (
    ...
    <div className=' w-full xl:h-[100px] h-[60px] flex justify-evenly items-center flex-row-reverse xl:text-xl text-lg whitespace-nowrap'>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600 '> تصویر </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600'> نام دوره </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600'> مدرس </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600'> ترم </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600'> تاریخ شروع </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center text-gray-600'> قیمت </div>
