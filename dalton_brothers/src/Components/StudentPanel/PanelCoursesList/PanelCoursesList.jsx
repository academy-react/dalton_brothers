...
const PanelCoursesList = () => {
  return (
    ...
    <div className=' w-full xl:h-[100px] h-[60px] flex justify-evenly items-center flex-row-reverse xl:text-xl text-lg whitespace-nowrap'>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> تصویر </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> نام دوره </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> مدرس </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> ترم </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> تاریخ شروع </div>
      <div className='w-[130px] xl:h-[50px] h-[40px] text-center '> قیمت </div>
      <div className='w-[60px] xl:h-[50px] h-[40px] text-center'>  </div>
    </div>
