...
const Dashboard = () => {
  return (
    <div className=" w-full h-full flex-col mt-10 ">
      <div className="flex justify-evenly max-2xl:flex-col-reverse max-2xl:justify-center max-2xl:items-center max-2xl:gap-[100px] max-2xl:mt-[50px] max-2xl:mb-[150px] w-full max-lg:items-center  gap-8 ">
        <div className=" 2xl:w-[370px] xl:w-[350px] lg:w-[300px] w-[400px] xl:h-[250px] lg:h-[250px] h-[200px]">
          <YourStock />
        </div>
        <div className=" 2xl:w-[800px] xl:w-[700px] xl:justify-start lg:w-[350px]  xl:h-[250px] lg:h-[250px] ">
          <Specification />
        </div>
      </div>
