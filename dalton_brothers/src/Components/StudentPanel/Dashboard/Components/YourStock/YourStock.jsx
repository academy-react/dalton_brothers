    ...
    <div className=" w-full h-full border border-gray-200 rounded-[30px] flex flex-row-reverse  whitespace-nowrap font-irSans relative bg-white dark:bg-mode-900 dark:border-DarkPallete-100">
      <div className=" lg:w-1/2 w-full h-full flex flex-col justify-between   ">
        ...
        <div className=" w-[150px] flex h-[60px] gap-1 xl:text-xl lg:text-lg justify-center items-center pt-8">
          <p className="text-gray-600 dark:text-mode-50"> تومان </p>
          <p className="text-gray-600 dark:text-mode-50"> 250000 </p>
        </div>
        ...
        <div className=" w-full  h-[60px] mt-[20px] lg:text-right text-center rounded-bl-[30px] flex justify-end">
          <button className="bg-pallete-100 dark:bg-DarkPallete-100  lg:w-full w-[100%] h-full rounded-tl-[30px] rounded-br-[30px] max-lg:rounded-tr-[30px] max-lg:rounded-b-md   flex justify-center items-center text-[16px] text-white font-irSBold">
            شارژ حساب
          </button>
        </div>
      </div>
